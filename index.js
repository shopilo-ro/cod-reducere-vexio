#!/usr/bin/env node
/**
 * Fetch coduri reducere Vexio de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/vexio.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/vexio.ro";
const STORE_NAME  = "Vexio";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-vexio)" }
  });
